...
# logs/reasoning/<date>_<TICKER>.log was truncated at that rate, and because decide.mjs:424
...
# (decide.mjs:36 awaits readStdin() at TOP LEVEL), emit reasoning chatter on stderr, print the
...
let stdin = "";
for await (const chunk of process.stdin) stdin += chunk;   // EOF-terminated, like decide.mjs:429
