...
for k in GLM_API_KEY DEEPSEEK_API_KEY OPENROUTER_API_KEY RH_ACCOUNT_NUMBER NOTIFY_TO RESEND_API_KEY RESEND_FROM NOTIFY_ALERTS_TO CLAUDE_CODE_OAUTH_TOKEN CONGRESS_API_KEY; do
